...
G*h*a-g*e-H*h*c))as             i32;if 0<y&&y<22&&0
 <x&&x<80&&(D)>z[o as         usize]{z[o as usize]
  =D;b[o as usize]=b".,-~:;=!*#$@"[if N>0{N as//M
